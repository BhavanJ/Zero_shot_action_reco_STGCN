...
#DTODO: CHANGE np.arrange(50)....to 60...NUMPY ARRAY [0....59]
			...
			if zsl_accuracy > last_accuracy:
				...
				# save networks
				torch.save(attribute_network.state_dict(),"./models_LTC/zsl_attribute_network_original_split.pkl")
				torch.save(relation_network.state_dict(),"./models_LTC/zsl_relation_network_original_split.pkl")
