...
print('LTC furthest split baseline exp 1, learning rate =', LEARNING_RATE)
...
#DTODO: CHANGE np.arrange(50)....to 60...NUMPY ARRAY [0....59]
			...
			if zsl_accuracy > last_accuracy:
				...
				# save networks
				torch.save(attribute_network.state_dict(),"./models_LTC/zsl_attribute_network_furthest_baseline_v1.pkl")
				torch.save(relation_network.state_dict(),"./models_LTC/zsl_relation_network_furthest_baseline_v1.pkl")
