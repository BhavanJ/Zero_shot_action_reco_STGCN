...
#FEATURE_DIR = './Furthest_neighbhour_features_80_epochs/'
...
print('LTC original split baseline exp 1, learning rate =', LEARNING_RATE)
...
#                                     relation_network =  2* size of visualfeat, some hidden size ....evnetaully this networks output is 1
	...
	relation_network = RelationNetwork(int(2*DIM_STGCN),int(DIM_STGCN/2))
...
#DTODO: CHANGE 4096        
		...
		# re_batch_labels = map(int, re_batch_labels)
...
#DTODO: CHANGE np.arrange(50)....to 60...NUMPY ARRAY [0....59]
			...
			if zsl_accuracy > last_accuracy:
				...
				# save networks
				torch.save(attribute_network.state_dict(),"./models_LTC/zsl_attribute_network_original_split_baseline_v1.pkl")
				torch.save(relation_network.state_dict(),"./models_LTC/zsl_relation_network_original_split_baseline_v1.pkl")
