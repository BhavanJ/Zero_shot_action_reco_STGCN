...
#unseen_classes = [4,9,12,17,52] # THIS IS THE OLD 

unseen_classes = [11,25,42,53,56] # For furthest neighbhours...classes go from 1 to 60 here 
# staggering [42,41]
# pat on back of other person [53,52]
# reading [11,10]
# put something inside pocket / take out something from pocket [25,24]
# giving something to other person [56,55]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/home/bjasani/Desktop/CMU_HW/VLR_project/STGN/data_download/nturgb+d_skeletons')#'data/NTU-RGB-D/nturgb+d_skeletons')
    parser.add_argument(
        '--ignored_sample_path',
        default='resource/NTU-RGB-D/samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='data/NTU-RGB-D_zero_shot_furtherest_neigh')
