...
SAVE_LOCATION = './work_dir/NTU-RGB-D_zero_shot_nearest_neigh/xview/ST_GCN_exp1_features/'
SAVE_NAME = '_exp_1'
...
def get_parser():
	...
	parser.add_argument(
		'--work-dir',
		default='./work_dir/NTU-RGB-D_zero_shot_nearest_neigh/xview/ST_GCN_exp1',
		help='the work folder for storing results')
	parser.add_argument(
		'--config',
		default='./config/st_gcn/nturgbd-cross-view_zero_shot_nearest_neigh/test.yaml', #NTU-RGB-D/xview/ST_GCN.yaml',
